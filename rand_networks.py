# This program creates graphs with random degrees distribution using the configuration model
# The methods used are based on networkx configuration model, however in this version loops and double edges are not formed
